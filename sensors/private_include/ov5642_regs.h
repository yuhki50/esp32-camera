 ...
 */
#ifndef __OV5642_REG_REGS_H__
#define __OV5642_REG_REGS_H__

/* system control registers */
#define SYSTEM_CTROL0   0x3008  // Bit[7]: Software reset  OV5642 COMPATIBLE
...
#define FORMAT_CTRL     0x501F // Format select OV5642 COMPATIBLE
                                // Bit[2:0]:
                                //  000: YUV422
                                //  001: RGB
                                //  010: YUV
                                //  011: RAW after DPC
                                //  101: RAW after CIP RAW
...
#define TIMING_TC_REG18 0x3818  // Timing Control
                                // Bit[6] Horizontal Mirror
                                // Bit[7] Vertical Flip

/* binning related registers */
#define ANALOG_CONTROL_D 0x370D // Bit[6] Verticle Binning enable
#define ARRAY_CONTROL01  0x3621 // Bit[7] Horizontal Binning enable
...
#define XY_OFFSET      0x3810 //Bit[3:0]: ISP horizontal offset[11:8]
// OV5642-INCompatible below
...
#define PCLK_RATIO       0x3815 // Bit[4:0]: PCLK ratio manual
#define VFIFO_CTRL0C     0x460C // Bit[1]: PCLK manual enable OV5642-COMPATIBLE
                                //          0: Auto
...
#define SC_PLLS_CTRL0    0x300F // Bit[7]: PLLS bypass OV5642-COMPATIBLE
#define SC_PLLS_CTRL1    0x3010 // Bit[4:0]: PLLS multiplier OV5642-COMPATIBLE
#define SC_PLLS_CTRL2    0x3011 // Bit[6:4]: PLLS charge pump control OV5642-COMPATIBLE
                                // Bit[3:0]: PLLS system divider
#define SC_PLLS_CTRL3    0x3012 // Bit[5:4]: PLLS pre-divider OV5642-COMPATIBLE
                                //          00: 1
                                //          01: 1.5
                                //          10: 2
                                //          11: 3
