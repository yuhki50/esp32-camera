#ifndef _OV5642_SETTINGS_H_
#define _OV5642_SETTINGS_H_
...
const DRAM_ATTR uint16_t ov5642_sensor_default_regs[][2] = {
...
//FORMAT_CTRL 0x501F
//FORMAT_CTRL00 0x4300

// OV5642 COMPATIBLE ?
const DRAM_ATTR uint16_t ov5642_sensor_fmt_jpeg[][2] = {
  {FORMAT_CTRL, 0x00}, // YUV422
  {FORMAT_CTRL00, 0x30}, // YUYV...
  {0x460C, 0x22}, // 0x20 to 0x02
  {0x460B, 0x35},
  {0x471D, 0x00}, // VSYNC extend when dummy line is inserted
  {0x3002, 0x0C}, // Reset SFIFO and Compression
  {0x3002, 0x00}, // Disable Reset
  {0x4713, 0x03}, // Compression mode 3
  {0x471C, 0x50}, // 0xD0 -> 0x50
  {0x3815, 0x44},
  {0x3818, 0x08}, // Compression Enable
  {0x3006, 0xFF}, // Enable all clocks
  {0x3007, 0x3F}, // Enable all clocks
  {REGLIST_TAIL, 0x00}, // tail
};

// OV5642 COMPATIBLE
const DRAM_ATTR uint16_t ov5642_sensor_fmt_raw[][2] = {
  {FORMAT_CTRL00, 0x00}, // RAW
  {REGLIST_TAIL, 0x00}
};

// OV5642 COMPATIBLE
const DRAM_ATTR uint16_t ov5642_sensor_fmt_grayscale[][2] = {
  {FORMAT_CTRL, 0x02}, // YUV422
  {FORMAT_CTRL00, 0x10}, // Y8
  {REGLIST_TAIL, 0x00}
};

// OV5642 COMPATIBLE
const DRAM_ATTR uint16_t ov5642_sensor_fmt_yuv422[][2] = {
  {FORMAT_CTRL, 0x02}, // YUV422
  {FORMAT_CTRL00, 0x30}, // YUYV...
  {REGLIST_TAIL, 0x00}
};
...
// OV5642 COMPATIBLE ?
const DRAM_ATTR uint16_t ov5642_sensor_fmt_rgb565[][2] = {
  {FORMAT_CTRL, 0x01}, // RGB
  {FORMAT_CTRL00, 0x61}, // RGB565 (BGR)
  {REGLIST_TAIL, 0x00}
};

const DRAM_ATTR uint8_t ov5642_sensor_saturation_levels[9][11] = {
...
const DRAM_ATTR uint8_t ov5642_sensor_special_effects[7][4] = {
...
const DRAM_ATTR uint16_t ov5642_auto_focus_regs[][2] =
{
  {0x3000, 0x20},
  {0x8000, 0x02},
  {0x8001, 0x00},
